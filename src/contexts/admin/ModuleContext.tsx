...
type ModuleType = "dashboard" | "document" | "code-couleur" | "demande" | "accueil" | "soumettre-demande" | "contact" | "rendez-vous" | "site" | "user" | "region" | "commune" | "categorie-domaine-entreprise" | "domaine-entreprise" | "type-demande";
