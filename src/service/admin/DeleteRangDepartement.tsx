...
const deleteRangDepartement = async (
    idRang: number,
    ...
    if (result.isConfirmed) {
      try {
        const response = await api.delete(`/api/departement_rangs/${idRang}`);
        ...
        await Swal.fire({
          ...
          text: langueActive === "fr" ? "Rang departement supprimé avec succès !" : langueActive === "en" ? "Departement order deleted successfully!" : "",
        ...
        Swal.fire({
          ...
          text: langueActive === "fr" ? "Erreur lors de la suppression du rang de departement." : langueActive === "en" ? "Error while deleting the departement order." : "",
          confirmButtonColor: "#ef4444",
          background: "#1c2d55",
          color: "#fff",
        });
  ...
  export default deleteRangDepartement;