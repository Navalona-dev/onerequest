          ...
          Swal.fire({
            ...
            if (error.response) {
              ...
              if (backendMessage) {
                ...
                errorMessage = langueActive?.indice === "fr" ? "Un rang pour ce departement et niveau hierarchique existe déjà." : 
                langueActive?.indice === "en" ? "An order with this department and hierarchy level already exists." : "";
              }
              else if (status === 404) {
