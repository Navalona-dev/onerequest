...
const AddNiveauHierarchique: React.FC<AddNiveauProps> = ({ setShowModalAdd }) => {
    ...
    const fieldLabels: { [key: string]: string } = {
      ...
      const handleSubmit = async (e: React.FormEvent) => {
        ...
        payload.departements = formData.departements;
                        ...
                        {Object.keys(formData).map((field) =>
                            ...
                            {field === "description" || field === "descriptionEn" ? (
                                ...
                                >
                                    ...
                                    <option key={dep.id} value={`/api/departements/${dep.id}`} className="mt-3">
