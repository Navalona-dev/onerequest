...
type Categorie = {
  ...
  const AddDomaineEntreprise: React.FC<AddDomaineEntrepriseProps> = ({ setShowModalAdd }) => {
    ...
    return(
        <>
            <div className="fixed inset-0 bg-[#111C44] bg-opacity-50 flex items-start justify-center pt-2 z-50 h-[100vh]">
              ...
              >
                <h2 className="text-xl font-bold mb-4 text-white">{t("addDomaineTitle")}</h2>
                ...
                {Object.keys(formData).map((field) =>
                        ...
                        {field === "description" || field === "descriptionEn" ? (
                            ...
                            rows={4}
                        />
                        ) : field === "categorieDomaineEntreprise" ? (
                          <select
